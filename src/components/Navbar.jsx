...
const [toggleMenu, setToggleMenu]= useState(false);
  ...
  return (
     <nav className='w-full h-[9vh] bg-[#7659e5]  flex items-center justify-between' >
          {/* Logo */}
          <div className=' logo  text-white bg-[#7659e5] font-bree font-bold text-[33px] tracking-wider	   w-[30%] md:w-[20%] h-[100%] pl-2 md:pl-7  flex items-center whitespace-nowrap justify-start' > Satish Dewasi </div>
          
          {/* nav itmes */}
          <div className={`  bg-[#7659e5] text-white absolute  ${toggleMenu ? 'top-[9vh]' : 'top-[-400px]'}   menu   w-full h-[40vh] md:static md:w-[60%] md:h-[9vh] `}  >
            
            {/* container */}
             
             <div className='w-[100%] h-[100%]  bg-[#7659e5] flex flex-col md:flex-row items-center justify-evenly ' >
                   {/* items container */}
